...
import (
	...
	"github.com/traas-stack/chaosmeta/chaosmetad/cmd/aidaemon"
	...
	"github.com/traas-stack/chaosmeta/chaosmetad/cmd/version"
...
func initRootCmd() {
	...
	rootCmd.AddCommand(aidaemon.NewAIDaemonCommand())
}
